      ...
      <section className="text-gray-600 mt-14 body-font">
        <div className="container  mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className=" lg:flex-grow md:w-1/2   lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 font-para text-sm leading-relaxed w-3/4 text-center">
            ...
            <form className="mt-10 lg:w-5/6 w-3/4">
              <div className="flex ">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="min-w-0  flex-auto rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm   placeholder:text-gray-900  sm:text-sm sm:leading-6 bg-gray-300"
                  placeholder="Enter your email"
                />
                <button
                  type="submit"
                  className="bg-black flex-none rounded-md px-2.5 lg:px-3.5 lg:py-5 text-sm lg:text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Start Collaboration
                </button>
              </div>
