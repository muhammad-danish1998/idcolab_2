    ...
    <div className="bg-yellow-400">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-7xl divide-y divide-black/10">
          <h2 className="font-heading lg:leading-loose title-font  sm:text-5xl text-center text-5xl mb-14 font-medium text-gray-900">
                  ...
                  <>
                    <dt>
                      <Disclosure.Button className="flex w-full items-start justify-between text-left text-black">
                        <span className=" lg:text-lg  leading-7 font-heading lg:space-x-4">
                          {faq.question}
                        </span>
                    ...
                    <Disclosure.Panel as="dd" className="mt-2 pr-12">
                      <p className="lg:text-lg  leading-7 font-heading  text-black">
                        {faq.answer}
                      </p>
                    </Disclosure.Panel>
                  </>
